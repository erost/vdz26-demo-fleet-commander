...
// Function returns composed resources for the public Strings XR.
...
func (f *Function) RunFunction(_ context.Context, req *fnv1.RunFunctionRequest) (*fnv1.RunFunctionResponse, error) {
	...
	if ocd, ok := observed[resource.Name("strings-object")]; ok {
	...
	desired[resource.Name("strings-object")] = &resource.DesiredComposed{Resource: composedObj, Ready: ready}
